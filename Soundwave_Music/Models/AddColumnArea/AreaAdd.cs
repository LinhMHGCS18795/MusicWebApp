...
{
    public partial class AreaAdd : DbContext
    {
        public AreaAdd()
            : base("name=AreaAdd")
        {
        ...
        public virtual DbSet<VIP_Package> VIP_Package { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<News>()
                .HasMany(e => e.Tags)
                .WithMany(e => e.News)
                .Map(m => m.ToTable("News_Tags").MapLeftKey("News_id").MapRightKey("Tags_id"));
            ...
            modelBuilder.Entity<VIP_Package>()
                .Property(e => e.Status)
                .IsFixedLength()
                .IsUnicode(false);
